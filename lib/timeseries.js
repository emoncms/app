...
var timeseries = {
    ...
    append: function (name,time,value)
    {
        if (datastore[name]==undefined) {
            app.log("ERROR","timeseries.append datastore["+name+"] is undefined");
            return false;
        }
    ...
    {
        if (datastore[name]==undefined) {
            app.log("ERROR","timeseries.trim_start datastore["+name+"] is undefined");
            return false;
        }
    ...
    {
        if (datastore[name]==undefined) {
            app.log("ERROR","timeseries.value datastore["+name+"] is undefined");
            return false;
        }
        
        if (datastore[name].data[index]==undefined) {
            app.log("ERROR","timeseries.value datastore["+name+"].data["+index+"] is undefined, data length: "+datastore[name].data.length);
            return null;
        } else {
    ...
    {
        if (datastore[name]==undefined) {
            app.log("ERROR","timeseries.data datastore["+name+"] is undefined");
            return [];
        }
