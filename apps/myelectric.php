...
<div id="app-setup" style="display:none; padding-top:50px" class="block">
    ...
    <h2 style="color:#0699fa">My Electric</h2>

    <div class="row">
      <div class="span9">
        <p class="a2">The My Electric app is a simple home energy monitoring app for exploring home or building electricity consumption over time. It includes a real-time view and a historic kWh per day bar graph.</p>
