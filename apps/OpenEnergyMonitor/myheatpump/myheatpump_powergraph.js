...
function powergraph_load() {
    ...
    var feeds_to_load = {
        ...
        "heatpump_flowT": { label: "FlowT", yaxis: 2, color: "#cb4b4b" },
        "heatpump_returnT": { label: "ReturnT", yaxis: 2, color: "#4da74d" },
        "heatpump_outsideT": { label: "OutsideT", yaxis: 2, color: "#c880ff" },
        "heatpump_roomT": { label: "RoomT", yaxis: 2, color: "#000" },
        "heatpump_flowrate": { label: "Flow rate", yaxis: 3, color: "#afd8f8" },
