<div id="graph-nav" class="visnavblock mb-2 d-flex justify-content-start d-flex justify-content-stretch btn-group">
    <button class='visnav time btn btn-inverse btn-link btn-large py-1 px-2' time='1'>1<?php echo tr('h') ?></button>
    <button class='visnav time btn btn-inverse btn-link btn-large py-1 px-2' time='3'>3<?php echo tr('h') ?></button>
    <button class='visnav time btn btn-inverse btn-link btn-large py-1 px-2' time='6'>6<?php echo tr('h') ?></button>
    ...
    <button class='visnav time btn btn-inverse btn-link btn-large py-1 px-2' time='8760'><?php echo tr('Y') ?></button>
