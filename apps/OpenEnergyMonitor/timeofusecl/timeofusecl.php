...
<div id="app-setup" class="block">
    <h2 class="app-config-title">Time of Use - flexible + CL</h2>

    <div class="app-config-description">
      <div class="app-config-description-inner">
        <p>The "Time of Use - flexible + CL" app is a simple home energy monitoring app for exploring home or building
        electricity consumption and cost over time. It allows you to track multiple electricity tariffs as
        used in Australia. This version adds a daily supply charge and a separately monitored controlled load
        (such as off-peak hot water).</p>
